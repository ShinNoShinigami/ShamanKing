...
public class StatGUIGuiWindow extends ContainerScreen<StatGUIGui.GuiContainerMod> {
	...
	private final static HashMap guistate = StatGUIGui.guistate;
	public StatGUIGuiWindow(StatGUIGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
