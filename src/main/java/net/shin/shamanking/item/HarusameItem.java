...
public class HarusameItem extends ShamankingModElements.ModElement {
	@ObjectHolder("shamanking:harusame")
	public static final Item block = null;
	public HarusameItem(ShamankingModElements instance) {
		super(instance, 1);
	}
