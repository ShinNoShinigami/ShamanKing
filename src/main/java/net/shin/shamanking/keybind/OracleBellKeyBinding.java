...
public class OracleBellKeyBinding extends ShamankingModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public OracleBellKeyBinding(ShamankingModElements instance) {
		super(instance, 19);
	...
	public void initElements() {
		keys = new KeyBinding("key.shamanking.oracle_bell", GLFW.GLFW_KEY_Z, "key.categories.shamanking");
