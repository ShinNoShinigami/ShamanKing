...
import net.shin.shamanking.procedures.SpiritInfusionOnKeyPressedProcedure;
...
public class SpiritInfusionKeyBinding extends ShamankingModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;
	public SpiritInfusionKeyBinding(ShamankingModElements instance) {
		super(instance, 13);
		...
		if (type == 0) {
			{
				...
				SpiritInfusionOnKeyPressedProcedure.executeProcedure($_dependencies);
			}
		}
	}
}
