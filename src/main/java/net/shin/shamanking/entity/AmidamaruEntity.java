...
package net.shin.shamanking.entity;
...
public class AmidamaruEntity extends ShamankingModElements.ModElement {
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			...
			this.goalSelector.addGoal(3, new FollowOwnerGoal(this, 1, (float) 5, (float) 1, false) {
				@Override
				public boolean shouldExecute() {
					...
					return super.shouldExecute() && Spirit1FollowProcedure.executeProcedure(ImmutableMap.of("entity", entity));
				}
				...
				public boolean shouldContinueExecuting() {
					...
					double z = CustomEntity.this.getPosZ();
					Entity entity = CustomEntity.this;
					return super.shouldContinueExecuting() && Spirit1FollowProcedure.executeProcedure(ImmutableMap.of("entity", entity));
				}
			});
